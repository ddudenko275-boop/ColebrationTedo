...
MASTER_SCALE_PD_BOUNDS = {
    "A1": (0.0000, 0.0030, 0.0015),
    "A2": (0.0030, 0.0050, 0.0040),
    "A3": (0.0050, 0.0080, 0.0065),
    "B1": (0.0080, 0.0120, 0.0100),
    "B2": (0.0120, 0.0180, 0.0150),
    "B3": (0.0180, 0.0300, 0.0240),
    "C1": (0.0300, 0.0576, 0.0405),
    "C2": (0.0576, 0.1407, 0.1032),
    "C3": (0.1407, 0.2600, 0.1998),
    "D1": (0.2600, 0.4000, 0.3300),
    "D2": (0.4000, 0.6000, 0.5000),
    "D3": (0.6000, 0.8000, 0.7000),
    "E": (0.8000, 1.0000, 0.9000),
}

...
MASTER_SCALE_PD_BOUNDS = {
    "A1": (0.0000, 0.0100, 0.0050),
    "A2": (0.0100, 0.0150, 0.0125),
    "A3": (0.0150, 0.0195, 0.0173),
    "B1": (0.0195, 0.0300, 0.0248),
    "B2": (0.0300, 0.0430, 0.0365),
    "B3": (0.0430, 0.0490, 0.0460),
    "C1": (0.0490, 0.0600, 0.0545),
    "C2": (0.0600, 0.0900, 0.0750),
    "C3": (0.0900, 0.1400, 0.1150),
    "D1": (0.1400, 0.2200, 0.1800),
    "D2": (0.2200, 0.3500, 0.2850),
    "D3": (0.3500, 0.5500, 0.4500),
    "E": (0.5500, 1.0000, 0.7000),
}
